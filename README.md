...
- 📚 Studying real-world incidents and defensive security concepts
- 🛠️ Building a small cybersecurity portfolio through hands-on practice
...
- Security Blue Team — Junior Security Analyst
- Cisco Cyber Defense Analyst
- IBM SkillsBuild — Governance, Risk, and Compliance & Data Privacy
...
- Security monitoring, log analysis, incident response basics
- Quietly interested in blue team work and eventually SOC analyst roles
